...
This folder contains shared/cross-system project notes. Mothership-specific and node-specific docs are in their respective folders:

- [mothership/docs/](../mothership/docs/) - mothership design notes (power, wake, LTE, PCB review)
- [node/docs/](../node/docs/) - node design notes (hardware, sensors, ultrasonic)
